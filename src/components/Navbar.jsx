        ...
        <div className="lg:hidden bg-slate-900 border-b border-slate-800 px-4 pt-2 pb-6 space-y-2 animate-fade-in">
          ...
          {currentUser && (
            <div className="pt-2 border-t border-slate-800 space-y-2">
              <button
                onClick={() => handleNavClick('socios')}
                className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-xs font-bold text-amber-400 hover:bg-slate-800"
              >
                <Users className="w-4 h-4" /> Intranet Socios
              </button>
              <button
                onClick={() => handleNavClick('voluntarios')}
                className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-xs font-bold text-emerald-400 hover:bg-slate-800"
              >
                <GraduationCap className="w-4 h-4" /> Intranet Voluntarios
              </button>
            </div>
