...
import { Mail, Globe, MapPin, Instagram, ShieldCheck, Heart } from 'lucide-react';
        ...
        <div className="border-t border-slate-800 pt-6 flex flex-col sm:flex-row items-center justify-between text-[11px] text-slate-500 gap-3">
          ...
          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1 text-slate-400">
              <ShieldCheck className="w-3.5 h-3.5 text-emerald-500" /> Sistema Seguro Cifrado
            </span>
          </div>
        </div>
